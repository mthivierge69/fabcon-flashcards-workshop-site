...
const topicsURL = "https://stadevfabconworkshop.blob.core.windows.net/$web/topics.json"
...
const QAsURL = "https://stadevfabconworkshop.blob.core.windows.net/$web/generated-QAs.json"
